...
Статус: ветка 2.7.x посвящена подготовке Windows-версии. В 2.7.0 зафиксированы ожидания будущего portable-комплекта, но exe и installer в этом релизе не собираются.
