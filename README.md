...
Статус: 2.9.1 восстанавливает запуск, если последняя выбранная папка экспорта удалена или недоступна. Parser, media endpoint, playback logic и search logic не менялись.
...
На Windows в portable-папке 2.9.1 обычный запуск - двойной клик по файлу:
